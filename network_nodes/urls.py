...
from network_nodes.views import NetworkNodeListAPIView, NetworkNodeCreateAPIView, NetworkNodeRetrieveAPIView, \
...
urlpatterns = [
    ...
    path("<int:pk>/", NetworkNodeRetrieveAPIView.as_view(), name="network-nodes-retrieve"),
    path("update/<int:pk>/", NetworkNodeUpdateAPIView.as_view(), name="network-nodes-update"),
    path(
        "delete/<int:pk>/",
